...
Multimedia::Multimedia(string _title, bool _subGenre[], string _description, bool _starred, bool _watched, unsigned int _year, string _producer, 
            string _language, QList <string> _platforms, Content* _inspiration=NULL):
            Content(_title, _subGenre, _description, _starred, _watched, _year, _inspiration),
            producer(_producer),
            language(_language),
