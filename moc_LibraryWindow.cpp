...
Q_CONSTINIT static const uint qt_meta_data_ZN13LibraryWindowE[] = {
 ...
 // slots: name, argc, parameters, tag, flags, initial metatype offsets
       ...
       9,    0,   67,    2, 0x28,    9 /* Private | MethodCloned */,
...
void LibraryWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 4: _t->editContent((*reinterpret_cast< std::add_pointer_t<Content*>>(_a[1]))); break;
        case 5: _t->editContent(); break;
        case 6: _t->hideDetailView(); break;
        default: ;
        }
    }
}
